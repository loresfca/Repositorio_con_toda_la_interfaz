...
class TuristicaViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    private let imagenes=["tips","derechos","obligaciones"]
    ...
    override	func prepareForSegue(segue:	UIStoryboardSegue,	sender:
        ...
        sigVista.nombreImagen=imagenes[indice!];
    }
    
    @IBAction func llamada(sender: AnyObject) {
        UIApplication.sharedApplication().openURL(NSURL(string:"telprompt:018000089090")!)
        
    }
    @IBAction func llamada2(sender: AnyObject) {
        UIApplication.sharedApplication().openURL(NSURL(string:"telprompt:52089898")!)
    }
    @IBAction func llamada3(sender: AnyObject) {
        UIApplication.sharedApplication().openURL(NSURL(string:"telprompt:018000074533")!)
    }
